...
// const helloReact = React.createElement("h1", null, "Hello React");                   //A React example
...
// ReactDom.render(helloReact, document.getElementById("root"));                        //Render the React example
